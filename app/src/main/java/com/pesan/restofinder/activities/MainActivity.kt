...
import com.pesan.restofinder.adapter.MainAdapter
import com.pesan.restofinder.adapter.MainAdapterHorizontal
import com.pesan.restofinder.model.ModelMain
import com.pesan.restofinder.model.ModelMainHorizontal
import com.pesan.restofinder.networking.ApiEndpoint
import com.pesan.restofinder.utils.OnItemClickCallback
    ...
    private fun showRecyclerResto() {
        ...
        mainAdapter?.setOnItemClickCallback(object : OnItemClickCallback {
            override fun onItemMainClicked(modelMain: ModelMain?) {
                val intent = Intent(this@MainActivity, Activity_DetailResto::class.java).also {
                    it.putExtra(Activity_DetailResto.DETAIL_RESTO, modelMain)
                    startActivity(it)
                }
            }
        })
