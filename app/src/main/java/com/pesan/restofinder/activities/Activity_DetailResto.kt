package com.pesan.restofinder.activities
...
import com.pesan.restofinder.R
import com.pesan.restofinder.adapter.HighlightsAdapter
import com.pesan.restofinder.adapter.ReviewAdapter
import com.pesan.restofinder.model.ModelHighlights
import com.pesan.restofinder.model.ModelMain
import com.pesan.restofinder.model.ModelReview
import com.pesan.restofinder.networking.ApiEndpoint
import kotlinx.android.synthetic.main.activity__detail_resto.*
import org.json.JSONException
import org.json.JSONObject

class Activity_DetailResto : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity__detail_resto)
    ...
    private fun getDetailResto() {
        ...
        AndroidNetworking.get(ApiEndpoint.BASEURL + ApiEndpoint.DetailRestaurant + IdResto)
            .addHeaders("user-key", "708c3cd5537ae58d1295be8b00bf1007")
            ...
            .getAsJSONObject(object : JSONObjectRequestListener {
                ...
                override fun onResponse(response: JSONObject) {
                    try {
                        ...
                        e.printStackTrace()
                        Toast.makeText(this@Activity_DetailResto,
            ...
            .getAsJSONObject(object : JSONObjectRequestListener {
                override fun onResponse(response: JSONObject) {
                    try {
                        ...
                        e.printStackTrace()
                        Toast.makeText(this@Activity_DetailResto, "Gagal menampilkan data!", Toast.LENGTH_SHORT).show()
                    }
                }

                override fun onError(anError: ANError) {
                    mProgressBar?.dismiss()
                    Toast.makeText(this@Activity_DetailResto, "Tidak ada jaringan internet!", Toast.LENGTH_SHORT).show()
                }
            })
    }
